...
void dadosAutomaticosItalia(tree **raiz){
    ...
    goleiro g6 = {"Alesio Buono", 0, 0, 29000, 83, "GOL"};
    ...
    goleiro g4 = {"Marenco", 0, 0, 21000, 81, "GOL"};
    ...
    goleiro g8 = {"Fumagalli", 0, 0, 16000, 78, "GOL"};
    ...
    jogador j1_2 = {"J. Henrique", 0, 0, 24000, 82, "ATA"};
    jogador j1_3 = {"Benedetti", 0, 0, 25000, 80, "ATA"};
    jogador j1_4 = {"Lorenzani", 0, 0, 20000, 80, "MEI"};
    jogador j1_5 = {"Vlad Marin", 0, 0, 22000, 81, "DEF"};
    goleiro g1 = {"Luigi Castelli", 0, 0, 18000, 79, "GOL"};
    ...
    goleiro g7 = {"Bernardo Leka", 0, 0, 50000, 86, "GOL"};
    ...
    goleiro g9 = {"G. Bressan", 0, 0, 50000, 87, "GOL"};
    ...
    goleiro g10 = {"A. Vagge", 0, 0, 34000, 84, "GOL"};
    ...
    goleiro g11 = {"Casapieri", 0, 0, 29000, 83, "GOL"};
    ...
    goleiro g12 = {"A. Luliano", 0, 0, 20000, 80, "GOL"};
    ...
    goleiro g3 = {"Vlad Caprianu", 0, 0, 29000, 82, "GOL"};
