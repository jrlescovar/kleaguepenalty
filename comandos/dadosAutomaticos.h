...
void dadosAutomaticos(tree **raiz) {
    ...
    times t8 = {5, "Fluxo FC", j8_1, j8_2, j8_3, j8_4, j8_5, g8, p8};
    ...
    times t9 = {3, "Desimpedidos Goti", j9_1, j9_2, j9_3, j9_4, j9_5, g9, p9};
    ...
    times t2 = {7, "Furia FC", j2_1, j2_2, j2_3, j2_4, j2_5, g2, p2};
    ...
    times t6 = {2, "Dendele FC", j6_1, j6_2, j6_3, j6_4, j6_5, g6, p6};
    insereABBrecursivo(raiz, t6);
    
    // Real Elite
    jogador j4_1 = {"Davi Ilario", 0, 0, 80000, 89};
    ...
    times t4 = {4, "FC Real Elite", j4_1, j4_2, j4_3, j4_4, j4_5, g4, p4};
    ...
    times t7 = {6, "Funkbol Clube", j7_1, j7_2, j7_3, j7_4, j7_5, g7, p7};
    ...
    times t5 = {9, "LOUD SC", j5_1, j5_2, j5_3, j5_4, j5_5, g5, p5};
    ...
    times t3 = {1, "Capim FC", j3_1, j3_2, j3_3, j3_4, j3_5, g3, p3};
    ...
    times t1 = {8, "G3X FC", j1_1, j1_2, j1_3, j1_4, j1_5, g1, p1};
    ...
    times t10 = {10, "Nyvelados FC", j10_1, j10_2, j10_3, j10_4, j10_5, g10, p10};
