...
void simularBrasil(listaDupla **lista, SemanaBrasil **campeonato, int rodada){
	...
	Confronto* confronto = semana->primeiroConfronto; //começar pelo 1 jogo
	i=0;
	do{
...
//rodar teste excluir isso em breve deixa uma unica função que puxa.
void jogarBrasil(listaDupla **lista, tree *resultado, SemanaBrasil **campeonato, int rodada){
	...
	i = 1; //começar de 1 repetir ate 5... são 5 jogos na rodada
	while(confronto != NULL && i <= 5){
